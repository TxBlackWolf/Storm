...
echo "----------------------"
cp $HOME/Storm/setup/clearCache.sh $HOME/TopScripts
cp $HOME/Storm/setup/pipUpdate.py $HOME/TopScripts
cp $HOME/Storm/setup/pip2Update.py $HOME/TopScripts
cp $HOME/Storm/setup/pgServer.sh $HOME/TopScripts
echo "----------------------"
