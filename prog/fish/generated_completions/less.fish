# less
# Autogenerated from man page /data/data/com.termux/files/usr/share/man/man1/less.1
...
complete -c less -s U -l UNDERLINE-SPECIAL --description 'Causes backspaces, tabs and carriage returns to be treated as control charact…'
...
complete -c less -l window --description 'Changes the default scrolling window size to n lines.'
...
complete -c less -s '!' --description 'Followed by one of the command line option letters, this will reset the optio…'
complete -c less -l '!' --description 'Like the -! command, but takes a long option name rather than a single option…'
